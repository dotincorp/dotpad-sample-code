...
namespace demo.app
{
    ...
    public class DotPadSDK
    {
        ...
        // 20셀 점자 표시
        [DllImport("DotPadSDK-1.4.0.dll", CharSet = CharSet.Unicode)]
        ...
        // 펑션키, 패닝키 콜백받는 함수
        [DllImport("DotPadSDK-1.4.0.dll")]
        public static extern DOT_PAD_SDK_ERROR DOT_PAD_REGISTER_MULTI_KEY_CALLBACK(MultiKeyPressCallbackFunc keyPressCallback, int interval);
