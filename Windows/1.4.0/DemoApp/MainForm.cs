...
namespace demo.app
{
    public partial class MainForm : Form
    {
        ...
        public delegate void MultiKeyPressCallbackFunc(int value);
        private static MultiKeyPressCallbackFunc multiKeyPresscallbackDelegate;
        ...
        {
            Debug.WriteLine("function key = " + value);
        ...
        public void MultiKeyPressCallback(int value)
        {
            Debug.WriteLine("multi key = " + value.ToString("X"));
            Console.WriteLine("multi key = " + value.ToString("X"));
        }
        ...
        private void buttonDotPad320Connect_Click(object sender, EventArgs e)
        {
            ...
            if (result == DOT_PAD_SDK_ERROR.DOT_ERROR_NONE) {
                ...
                // 닷패드 다중키 콜백 이벤트 등록
                multiKeyPresscallbackDelegate = new MultiKeyPressCallbackFunc(MultiKeyPressCallback);
                DotPadSDK.DOT_PAD_REGISTER_MULTI_KEY_CALLBACK(multiKeyPresscallbackDelegate, 200);
