...
namespace demo.app
{
    public class DotPadSDK
    {
        ...
        // 20셀 점자 표시
        [DllImport("DotPadSDK-1.0.0.dll", CharSet = CharSet.Unicode)]
        public static extern ERROR_CODE DOT_PAD_BRAILLE_DISPLAY(StringBuilder input, int language);
